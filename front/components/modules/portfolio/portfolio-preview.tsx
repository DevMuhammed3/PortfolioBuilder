...
export function PortfolioPreview({
  ...
  console.log("TEMPLATE OBJECT:", portfolio.templateId);
  console.log("TEMPLATE SLUG:", portfolio.templateId?.slug);
  useEffect(() => {
  ...
  function renderTemplate() {
    const slug = portfolio.templateId?.slug;
    ...
    switch (slug) {
      ...
      case "creative-split":
        return <CreativeSplitTemplate portfolio={portfolio} />;
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Main Content */}
      <main
        className={`${!isPremium ? "pointer-events-none select-none blur-sm" : ""
          }`}
      >
